...
import { StyleSheet, TouchableWithoutFeedback, Platform, StatusBar, Animated } from "react-native";

import PropTypes from "prop-types";
import renderFlashMessageIcon from "./FlashMessageIcon";
...
export default class FlashMessage extends Component {
  static defaultProps = {
     ...
     */
    MessageComponent: FlashMessageTemplate
  };
  static propTypes = {
  ...
  render() {
    ...
    return (
      <Animated.View style={[positionStyle(styles.root, position), position === "center" && !!message && styles.rootCenterEnabled, animStyle]}>
        {!!message && (
