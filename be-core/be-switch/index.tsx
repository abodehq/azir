...
const LcSwitch: React.FC<Props> = props => {
  ...
  const trackColor = {
    false: LCTheme.COLORS.GREY,
    true: _color
  };

  return (
    <Switch disabled={disabled} trackColor={trackColor} ios_backgroundColor={LCTheme.COLORS.GREY} value={checked} thumbColor={thumbColor} onValueChange={onPressSwitch} {...rest} />
  );
};
...
export default withLC(LcSwitch, styles);
